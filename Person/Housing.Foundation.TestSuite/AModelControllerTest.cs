using Housing.Foundation.Apartment.Service.Controllers;
using Housing.Foundation.Library.Abstracts;
using Housing.Foundation.Library.Interfaces;
using Housing.Foundation.Person.Service.Controllers;
...
using Xunit;
using ACM = Housing.Foundation.Apartment.Context.Models;
using PCM = Housing.Foundation.Person.Context.Models;

namespace Housing.Foundation.TestSuite
{
